...
export function ImportData(arg1:string,arg2:string,arg3:string,arg4:Array<number>):Promise<void>;

export function OptimizeSQL(arg1:string):Promise<string>;
...
export function UpdateTableSchema(arg1:string,arg2:string,arg3:string):Promise<void>;
